...
#
# Generated by Vivado on Sat Nov 25 23:30:12 +0800 2017
...
# Script info
echo -e "PLL.sh - Script generated by export_simulation (Vivado v2016.4 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot PLL xil_defaultlib.PLL xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim PLL -key {Behavioral:sim_1:Functional:PLL} -tclbatch cmd.tcl -log simulate.log
}
